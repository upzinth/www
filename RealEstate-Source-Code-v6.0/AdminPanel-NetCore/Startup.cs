...
namespace RealEstate
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RealEstateContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Default")));
            ...
            .AddJwtBearer(x =>
            {
                x.Events = new JwtBearerEvents
                {
                    ...
                    {
                        var _dbContext = context.HttpContext.RequestServices.GetRequiredService<RealEstateContext>();
